            ...
            <div class="col-sm-3 p-5  text-center">
                <div class="text-left pl-5">
                    ...
                    <a href="/account-settings/clients">
                        <h5 class="ml-5 pl-5"><b style="color:red"> My Clients</b></h5>
                    </a>
                    <hr>
                    ...
                    <hr>
                    <div class="ml-5 pl-5 d-flex drill_cursor" style="background-color: white !important; ">
                        <button @click="logout()" class="btn"  >            
                            <div class=" d-flex drill_cursor">
                            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27"  class="bi bi-box-arrow-right mr-3" viewBox="0 0 16 16">
