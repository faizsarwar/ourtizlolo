    ...
    <div class="p-5 " style="background-color: black;" id="home-hero">
      <div class="row p-5  text-left d-flex justify-content-center">
        <div class="col-3  ml-5 pl-5">
          <h2><b> Reimagine your financial future with Cadre.</b></h2>
          <p class="mt-4">Cadre's revolutionary platform breaks barriers to commercial real estate investing. We use the same high-quality underwriting available for deals to individuals, advisors, and institutions.</p>
        ...
        <p class="mt-5 text-center" style="color:#818181 !important">Are you a registered investment advisor or institution? Learn how Cadre can partner with you.
          ...
          <section id="home-best-known">
            ...
            <div id="LIQUIDITY" class="tabcontent " style="display:block">
                ...
                <div class="text-left m-3 mr-5">
                  <h1>Reimagine <br>
                    ...
                    <p style="color: #818181;" class="mt-4">
                      The Cadre Secondary Market offers unprecedented <br> opportunities for liquidity
                    </p>
                    ...
                    <p style="color: #818181;">
                      It’s a win-win. And it’s only at Cadre.
                    </p>
              ...
              <h4 style="color: #818181;" class="m-4">
                “Cadre built a StubHub-like secondary market that can help <br> investors exit their investment with a few mouse clicks, and has <br> handled hundreds of secondary transactions for investors.”
              </h4>
            </div>
              ...
              <div class="d-flex justify-content-center">
                <div class="text-left m-3 mr-5">
                  <h1>Comprehensive investment<br>
                    ...
                    <p style="color: #818181;" class="mt-4">
                      Legacy real estate funds rarely offer you a clear <br> view of the investment road ahead. Cadre <br> provides unprecedented asset level transparency, <br> so you can see exactly which properties you own <br> and understand how your investment is <br> performing at every turn.
                    </p>
                    <button type="button" class="btn p-2 ml-3 pl-5 pr-5" style="border-radius:20px !important; background-color:purple; color:white">Learn More</button>
                </div>
                <div class="m-3 ml-5">
              ...
              <div class="d-flex justify-content-center">
                <div class="text-left m-3 mr-5">
                  <h1><b style="color: purple;"> Revolutionary, data-driven. </b><br>investment approach.
                    ...
                    <p style="color: #818181;" class="mt-4">
                      Cadre built proprietary data science tools to <br> improve upon traditional real estate processes. <br> Our technology produces deeper investment <br> insights that improve investment performance,⁴ <br> while creating efficiencies that allow us to reduce <br> costs for our investors. </p>
                    <button type="button" class="btn p-2 ml-3 pl-5 pr-5" style="border-radius:20px !important; background-color:purple; color:white">Learn More</button>
                </div>
                <div class="m-3 ml-5">
                  <h1>picture here </h1>
          ...
          <section class="p-5" id="home-tabs">
            ...
            <div class="text-left d-flex justify-content-center">
              <div class="m-4">
                <h4><b style="color:black;"> Why Cadre? </b></h4>
              ...
              <div class="m-4">
                ...
                <p style="color: black;">If you’re not investing in real estate, you may be <br> leaving money on the table. Answer just a few <br> qualifying questions to join our cadre of investors <br> and you could change your financial trajectory.</p>
              </div>
            </div>
          </section>
          ...
          <section class="p-5" style="background-color: purple;" id="home-wealth">
            <div class="p-5">
              <div class="pt-5 mt-3">
                ...
                <p class="mt-4">Learn how you can invest in Cadre Funds and other opportunities.</p>
              </div>
