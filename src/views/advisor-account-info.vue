          ...
          <form class="m-5" @submit.prevent="submitForm">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <select class="form-control" aria-label="Default select example" v-model="Role" required>
            ...
            <div class="row">
                  <div class="form-group col-md-6">
                    <label for="Address1" >If you dont have your crd number you can easily locate it at <a href="https://brokercheck.finra.org/"> BrokerCheck </a> By Typing In your name</label>
                    <input type="text" class="form-control" v-model="advisor_crd_number" placeholder="Enter your CRD">
                  </div>
            </div>
  ...
  submitForm() {
    ...
    if (!this.errors.length) {
      const formData = {
        ...
        advisor_crd_number: this.advisor_crd_number,
        advisor_role: this.Role
      };
      axios
        .post("/api/v1/CustomAdvisorUser/", formData)
        .then((response) => {
