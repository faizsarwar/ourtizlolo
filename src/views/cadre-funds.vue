        ...
        <section class="pl-5">
            <div class="row m-5 pl-5">
                <div class="col pt-5 pl-5 text-left">
                    ...
                    <p style="color: black;">Sign up in seconds to get notified when new Cadre Funds are open for investmen</p>
        ...
        <section class="p-5" style="background-color: #f5f5f5;">
            ...
            <div class="p-5 row">
                <div class="col p-5 text-left">
                    <h1 class="ml-5" ><b style="color: black;"> Don't miss out on </b> <br><b style="color:purple"> Cadre's next fund</b>!</h1>
                    <p  class="ml-5" style="color: black;">If you missed out on the success of our flagship Cadre Direct <br> Access Fund, sign up now to be notified for your next <br> opportunity to outperform with Cadre Funds. </p>
            ...
            <div class="p-3 mt-4 d-flex justify-content-center">
                                  ...
                                  <div class="ml-3 mr-3">
                                    <div class="card p-4" style="width: 25rem;">
                                      <div class=" pt-3 pb-2" >
                                        <h4><b style="color:black"> Access to Experiencen </b></h4>
                                      </div>
                                      <div class="card-body" style="height:10rem">
                                        <p class="card-title pl-3 pr-3 mb-4" style="color: black;">Leverage Cadre’s decades of institutional experience and broad operator network and invest alongside leading endowments, asset managers and pension funds.</p>
                                      </div>
                                    </div>
                                  </div>
                                                    <!-- card -->
                  <div class="ml-3 mr-3">
                    <div class="card p-4" style="width: 25rem;">
                      <div class=" pt-3 pb-2">
                        <h4><b style="color:black"> Instant Diversification </b></h4>
                      </div>
                      <div class="card-body" style="height:10rem">
                        <p class="card-title pl-3 pr-3 mb-4" style="color: black;">Invest in a diversified portfolio of private commercial real estate to build wealth more efficiently across markets and property types.</p>
                      </div>
                    </div>
                  </div>
                                    <!-- card -->
                                    <div class="ml-3 mr-3">
                                        <div class="card p-4" style="width: 25rem;">
                                          <div class=" pt-3 pb-2">
                                            <h4><b style="color:black"> Focus on Alpha Generation </b></h4>
                                          </div>
                                          <div class="card-body" style="height:10rem">
                                            <p class="card-title pl-3 pr-3 mb-4" style="color: black;">Access a portfolio carefully constructed to outperform by seasoned real estate investment professionals and backed by data science.</p>
                                          </div>
                                        </div>
                                      </div>
            </div>
        ...
        <section class="pb-5">
            <div class="p-5 m-5 d-flex justify-content-center">
                <div class="tab">
                  ...
                  <button class="tablinks m-4 p-2 btn btn-light" onclick="openCity(event, 'Data-Driven')">Data Driven</button>
                  <button class="tablinks m-4 p-2 btn btn-light" onclick="openCity(event, 'Client-Centric')">Client-Centric</button>
                </div>              
              </div>
              ...
              <div id="Direct-Investments" class="tabcontent pb-5" style="display:block">
                ...
                <p style="color:black">Click here to learn more about our flagship fund, the Cadre Direct Access Fund (now closed to investors).</p>
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <div class="text-left m-3 ml-5">
                      <h1><b style="color: purple;">Data-Driven </b><br> Market Selection  <br>
                        ...
                        <p style="color: #818181;" class="mt-4">
                            Benefit from Cadre’s strategic combination of real estate investment <br> insights and predictive analytics we use to identify assets with attractive<br>  return profiles in top-growth markets.
                        </p>
                    </div>
                  </div>
                  <p style="color:black">Click here to learn more about our flagship fund, the Cadre Direct Access Fund (now closed to investors).</p>
