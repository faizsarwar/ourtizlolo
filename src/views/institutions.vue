      ...
      <div class="p-5" style="background-color: #f5f5f5;" id="home-improve">
        <div class="p-5 d-flex justify-content-center">
            <div class="p-5">
                ...
                <div>
                    <p style="color: black;">Cadre’s investment platform is designed to deliver <br> compelling risk-adjusted returns with the potential for <br> liquidity on a quarterly basis.</p>
                </div>
            </div>
            <div class="p-5">
                img here
            ...
            <div class="text-left p-5 m-3 mr-5">
              <h1><b style="color: black;"> Optimize alpha through tech efficiencies.</b></h1>
                <p style="color: #818181;" class="mt-4">
                    Data science and machine learning tools fuel Cadre’s fee <br> efficient real estate investment solutions, from separate <br> accounts to funds. Our tech-driven platform helps <br> institutions search for alpha cost-effectively, across broad or <br> niche private real estate strategies.
                </p>
          ...
          <div class="d-flex justify-content-center">
            ...
            <div class="text-left m-3 mr-5">
              <h1><b style="color: black;">  Control your investment horizon. </b></h1>
                <p style="color: #818181;" class="mt-4">
                    Asset liability matching and portfolio rebalancing on <br> demand: Cadre’s groundbreaking pool of liquidity offers <br> institutional investors the potential to exit private real estate <br> investments on a quarterly basis.
                </p>
                <p class="mt-5" style="color: #818181;">Liquidity Not Guaranteed. Investments offered by Cadre are illiquid and there is <br> never any guarantee that you will be able to exit your investments on the <br>  Secondary Market or at what price an exit (if any) will be achieved.
                    ‍</p>
          ...
          <div class="d-flex justify-content-center">
            ...
            <div class="text-left m-3 mr-5">
              <h1><b style="color: black;">Granular insights into assets at all times.</b></h1>
                <p style="color: #818181;" class="mt-4">Cadre uses proprietary data science tools to compile <br> comprehensive, transparent details on each asset we offer <br> for investment. Performance reporting, updates, and <br> analytics are available 24-7 for investors on our platform.</p>
            </div>
          </div>
          <h4 style="color: #818181;" class="m-4">“Cadre accomplishes its goals with technology, which it <br> employs to provide investors with a transparent platform that <br> they can log into to learn of new investment opportunities, to <br> get data on properties and markets, and to get practical <br> information about individual portfolios.”</h4>
        ...
        <div>
            ...
            <section class="bg-light" id="home-performance">
              <div class="p-5 mb-5">
                <div class="pl-5 pt-5 pr-5 mt-5 mb-5">
                  ...
                  <p style="color: black;" class="pl-5 pr-5 mt-4 text-center">Cadre is a minority-owned, minority-led investment manager. Our diversity, equity, and inclusion <br> (DEI) strategy is core to all we do, and includes initiatives to:
                    ‍</p>  
            ...
            <section class="p-5" style="background-color: purple;">
                <div class="p-5 m-5">
                    ...
                    <p class="mb-5">Connect with Cadre to invest.</p>
