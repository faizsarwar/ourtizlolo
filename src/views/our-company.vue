    ...
    <div>
        ...
        <section class="p-5" id="home-performance">
            <div class="p-5 ">
                ...
                <p style="color: black;" class="mt-4">Cadre uses predictive models and workflow tools to reengineer the investment experience. Our real <br> estate investment platform is distinguished in its ability to gather, analyze, and leverage information, <br> with radical improvements in workflow efficiency.
                </p>
            </div>
            ...
            <div class="d-flex justify-content-center text-left  mt-2 mb-2" id="home-efficient">
                ...
                <div class="m-4">
                    ...
                    <p style="color:black">Proprietary machine learning models analyze tens of thousands <br> of variables to identify the U.S. real estate markets with the <br> highest potential for price appreciation and income generation: <br> the Cadre 15.1</p>
            ...
            <div class="d-flex justify-content-center text-left mt-2 mb-2" id="home-best-known">
                ...
                <div class="m-4">
                    ...
                    <p style="color:black">Millions of granular data points are ingested into Cadre’s real <br> estate deal management software. These data insights provide a <br> meaningful competitive edge, by enabling Cadre to more <br> accurately identify trending locations and project rent growth. <br> As a result, we can more quickly identify selective investment <br> opportunities through our tech-enabled underwriting process                   </p>
                    <button type="button" class="btn p-2 pl-3 pr-3" style="border-radius:20px !important; background-color:purple; color:white">Learn More</button>
                </div>
            </div>
